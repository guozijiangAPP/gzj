	...
	<view>
		...
		<view class="cu-bar tabbar bg-color3a shadow foot">
			<view class="action" @click="navChange" data-cur="Main">
				...
				<!-- <h1 v-if="view=='Main'">
					<view class="cu-avatar xs bar-img" style="background-image:url(../../../static/images/l1.png);"></view>
				</h1>
				<h1 v-else>
					<view class="cu-avatar xs bar-img" style="background-image:url(../../../static/images/l2.png);"></view>
				</h1> -->
				<view class="text-df" :class="view=='Main'?'text-red':'text-gray'">首页</view>
			</view>
			<view class="action" @click="navChange" data-cur="About">
				<view :class="view=='About'?'cuIcon-myfill text-red':'cuIcon-my text-gray'"></view>
				<view class="text-df" :class="view=='About'?'text-red':'text-gray'">我的</view>
			</view>
		</view>
	</view>
</template>
